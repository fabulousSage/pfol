...
export const experience = [
	{
		...
		desc: "High PerforT Authentication, AWS, Integrated Plaid APIs for Fetching Bank Transactions, Integrated Sentry for monitoring Django Server and deployed the API on Heroku Server.",
		 descBullets: [
		 	"",
		 	"",
		 ],
